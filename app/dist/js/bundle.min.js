...
*/
      ...
      angular.module(name, []).directive('blogaHeader', require('./header')).directive('blogaFooter', require('./footer')).directive('blogaMenu', require('./menu'));
    },
    {
      './footer': 7,
      './header': 8,
...
*/
    ...
    {
      './angular-animate.min': 14,
      './angular-resource.min': 15,
      './angular-route.min': 16,
      './angular-touch.min': 17,
      './angular.min': 18,
      './rulee-promise': 19
    }
  ],
