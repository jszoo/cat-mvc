...
*/
      ...
      angular.module(name, []).directive('ruleeHeader', require('./header')).directive('ruleeFooter', require('./footer')).directive('ruleeMenu', require('./menu')).directive('imgSrc', require('./imgsrc'));
    },
    {
      './footer': 7,
      './header': 8,
...
*/
      ...
      angular.module(name, []).filter('i18n', require('./i18n'));
    },
    { './i18n': 13 }
  ],
  13: [
...
*/
    ...
    {
      './angular-animate.min': 15,
      './angular-resource.min': 16,
      './angular-route.min': 17,
      './angular-touch.min': 18,
      './angular.min': 19,
      './rulee-promise': 20
    }
  ],
...
*/
      'use strict';
      var type = require('../utilities/all').type, isFunc = function (fn) {
