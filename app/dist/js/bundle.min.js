...
*/
      ...
      angular.module(name, []).controller('MainCtrl', require('./main-controller')).controller('HomeCtrl', require('./home-controller'));
    },
    {
      './home-controller': 2,
      './main-controller': 3
...
*/
      module.exports = [
        ...
        'testFactory',
        'testProvider',
        function ($scope, $rootScope, $window, $location, testService, testFactory, testProvider) {
          $scope.slide = '';
...
*/
      ...
      angular.module(name, []).factory('Blogs', require('./blog-service'));
    },
    { './blog-service': 5 }
  ],
  5: [
...
*/
      ...
      angular.module(name, []).directive('blogaHeader', require('./header'));
    },
    { './header': 7 }
  ],
  7: [
      ...
      bloga.config([
        ...
        function ($routeProvider, utils) {
          $routeProvider.when('/home', {
            templateUrl: utils.viewUrl('views/home.html'),
            controller: 'HomeCtrl'
          });
...
*/
    ...
    {
      './angular-animate.min': 10,
      './angular-resource.min': 11,
      './angular-route.min': 12,
      './angular-touch.min': 13,
      './angular.min': 14,
      './rulee-promise-chrome': 15
    }
  ],
  10: [
    function (require, module, exports) {
...
*/
      'use strict';
      var type = require('../utilities/all').type, arg2arr = require('../utilities/all').arg2arr, isFunc = function (fn) {
      ...
      Promise.prototype = {
        ...
        then: function (onResolved, onRejected) {
          if (isFunc(onResolved)) {
            if (this._status === STATUS.pending) {
              this._resolves.push(onResolved);
      ...
      Promise.all = function (promises) {
        var doResolve, promise = new Promise(function (resolve, reject) {
            doResolve = resolve;
          });
        var resolveNum = 0, thenableNum = 0, results = [];
...
* create date: 2014.5.4
*/
      module.exports = [require('./test1/all').name];
    },
    { './test1/all': 17 }
  ],
  17: [
...
*/
      ...
      angular.module(name, []).provider('testProvider', require('./test1-provider')).factory('testFactory', require('./test1-factory')).service('testService', require('./test1-service'));  /*
...
*/
      ...
      var readObj = function (obj, namespace) {
        ...
        angular.forEach(names, function (key, i) {
          if (key && ret) {
            ret = isNaN(key) ? key === ')' ? ret() : ret[key] : ret[parseInt(key, 10)];
          }
        });
        return ret;
      };
      module.exports = {
        ...
        type: function () {
          ...
          for (var i = 0; i < natives.length; i++) {
            class2type['[object ' + natives[i] + ']'] = natives[i].toLowerCase();
          }
          return function (obj) {
