...
*/
      ...
      angular.module(name, []).directive('cmsHeader', require('./header')).directive('cmsFooter', require('./footer')).directive('cmsMenu', require('./menu')).directive('imgSrc', require('./imgsrc'));
    },
    {
      './footer': 7,
      './header': 8,
...
*/
      module.exports = {
        ...
        readObj: function (obj, namespace) {
          ...
          this.each(names, function (i, key) {
            if (key && ret) {
        ...
        mapObj: function (obj, namespace, dft) {
          ...
          this.each(parts, function (i, key) {
            if (key) {
              names.push(key);
            }
          });
          ...
          this.each(names, function (i, key) {
            prev = curr;
            curr = curr[key] ? curr[key] : curr[key] = isNaN(names[i + 1]) ? {} : [];
          });
          if (prev) {
            prev[lastName] = dft;
          }
